...
class MyAdapter extends ArrayAdapter<StateVO> {
    ...
    private boolean[] isCheckedArray = new boolean[] {false, false, false};
    ...
    public View getCustomView(final int position, View convertView,
        ...
        holder.mCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Log.e("onCheckedChanged: ", ""+buttonView.getTag() );
                int getPosition = (Integer) buttonView.getTag();
                isCheckedArray[getPosition-1]=isChecked;
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                    getNearbyPlacesData.add_filters(isCheckedArray);
